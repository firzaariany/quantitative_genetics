...
## Counting the completely resistant individuals (meaning that they are not
...
# The distribution of trait variation per pathogen
We will subset the raw data set that has been cleaned (i.e. test1_NA_nodisc)
then we will proceed to the graphical inspection of each trait for each pathogen.
