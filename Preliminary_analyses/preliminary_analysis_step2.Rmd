...
# Objectives  
1. Observe the trait mean across blocks (Genotypic mean) and genotypes (Block mean)
2. Graphical inspection of genotypic mean across block
...
# Comparing the genotypic mean and block mean in graphs
Visual comparison to see whether genotypic mean and block mean are different or not. Genotypes and blocks have to be converted from character to factor.
