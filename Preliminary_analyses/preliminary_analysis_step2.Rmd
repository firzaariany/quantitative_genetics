...
I used was 154 individuals spanning across 5 blocks. Each individual in
...
As I mentioned above, the data was collected from an experimental design
of 154 individuals that were spread across 5 blocks. In each block the
individuals were infected with 3 pathogens.
...
It is not very easy to compare UN variation across pathogens. There is a
high range for UN for each pathogen. However, I can see that individuals
infected by pathogen 09AX27 showed smaller amount of uredinia than the
other individuals infected by 93JE3 and P72. Individuals infected by P72
showed the largest amount of uredinia, but most of them were showing
uredinia number far below the largest amount.
...
The uredinia size (the size of the spore that present on the poplar
leaves) was scored in 1 - 5 scales. In this graph, I can see that the
pathogen 93JE3 creates big spore sizes in more poplars than the other
two pathogens. It is indicated by more uniformity of the red color in
the graph for pathogen 93JE3 than in the graphs for the other two
pathogens.
...
spread across 5 blocks. So, now I want to see the overall response of
the individuals regardless of the blocks. To do this, I will need to
average individual response by dividing it with 5, which is the number
of blocks I have.
