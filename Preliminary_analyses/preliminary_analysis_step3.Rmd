...
```{r extract 09AX27, message=FALSE, warning=FALSE, include=FALSE}
write.table(adj_s09AX27, "adj_traits_s09AX27.txt", sep = "\t", na = "NA", 
            quote = FALSE, row.names = FALSE)
```

```{r extract 93JE3, message=FALSE, warning=FALSE, include=FALSE}
write.table(adj_s93JE3, "adj_traits_s93JE3.txt", sep = "\t", na = "NA", 
            quote = FALSE, row.names = FALSE)
```

```{r extract P72, message=FALSE, warning=FALSE, include=FALSE}
